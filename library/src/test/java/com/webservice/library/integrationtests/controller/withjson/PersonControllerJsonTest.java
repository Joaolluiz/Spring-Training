...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
    ...
    public void testHateoas() throws JsonMappingException, JsonProcessingException {
        ...
        assertTrue(content.contains("_links\":{\"self\":{\"href\":\"http://localhost:80/api/person/v1/404\"}}}"));
        assertTrue(content.contains("_links\":{\"self\":{\"href\":\"http://localhost:80/api/person/v1/274\"}}}"));
        assertTrue(content.contains("_links\":{\"self\":{\"href\":\"http://localhost:80/api/person/v1/785\"}}}"));

        assertTrue(content.contains("prev\":{\"href\":\"http://localhost:80/api/person/v1?direction=asc&page=2&size=10&sort=firstName,desc\"}"));
        assertTrue(content.contains("self\":{\"href\":\"http://localhost:80/api/person/v1?page=3&size=10&direction=asc\"}"));
        assertTrue(content.contains("next\":{\"href\":\"http://localhost:80/api/person/v1?direction=asc&page=4&size=10&sort=firstName,desc\""));
        assertTrue(content.contains("last\":{\"href\":\"http://localhost:80/api/person/v1?direction=asc&page=100&size=10&sort=firstName,desc\"}}"));
